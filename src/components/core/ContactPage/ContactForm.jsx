                ...
                <div className="flex flex-col gap-6">
                    <div className="flex gap-5">
                        ...
                        <div className="flex flex-col gap-2 grow">
                            ...
                            />
                            {errors.firstName && <div className="mt-1 text-xs text-brown-100">Please enter your name</div>}
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        />
                        {errors.email && <div className="mt-1 text-xs text-brown-100">Please enter your email</div>}
                    </div>
                        ...
                        <div className="flex gap-2">
                            ...
                            <input
                                ...
                                {...register('phoneNumber',
                                    {
                                        required: { value: true, message: 'Please enter your contact' },
                                        maxLength: { value: 11, message: 'Please enter a valid number' },
                                        minLength: { value: 8, message: 'Please enter a valid number' },
                                    })
                                }
                            />
                        </div>
                        {/* {console.log(errors)} */}
                        {errors.phoneNumber && <div className="mt-1 text-xs text-brown-100"> {errors.phoneNumber.message} </div>}
                    ...
                    {/* <PhoneInput
                        ...
                        value={value}
                        onChange={setValue}
                        className="w-10 text-black placeholder:text-richblack-200 "
                        defaultCountry="IN"
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        />
                        {errors.message && <div className="mt-1 text-xs text-brown-100">Please enter your message</div>}

                    </div>

                    <button type="submit" className="w-full p-3 text-base font-medium text-center rounded-md bg-yellow-50 text-richblack-900">Send Message</button>
                </div>
            </form>
            {/* </div> */}
        </div>
