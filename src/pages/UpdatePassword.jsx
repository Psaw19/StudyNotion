            ...
            <div className='max-w-[1440px] mx-auto px-[120px] py-24 flex justify-center'>
                ...
                <div className='flex flex-col w-1/3 gap-5'>
                    ...
                    <p className='text-lg text-richblack-100'>
                        {
                            reset ? `All done! We have sent an email to ${email} to confirm` : 'Almost done. Enter your new password and youre all set.'
                        }
                    ...
                    </p>
                    {
                        ...
                        <form onSubmit={handleSubmit((data) => getFormData(data))} className='flex flex-col gap-6' >
                            <div className="flex flex-col gap-2">
                                ...
                                {errors.email && <div className="mt-1 text-xs text-brown-100">Please enter your password</div>}
                            </div>
                            <div className="flex flex-col gap-2">
                                ...
                                {errors.email && <div className="mt-1 text-xs text-brown-100">Please re-enter your password</div>}
                            </div>
                            <IconBtn active={true} type='submit'>Reset Password</IconBtn>
                        </form>
                    }

                    {
                        reset &&
                        <Link to='/login' className='px-5 py-2 text-base font-medium text-center rounded text-richblack-900 bg-yellow-50'>Return to login</Link>
                    }
